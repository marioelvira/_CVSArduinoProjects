...
void _serveMAIN()
{
  ...
  html = html + "<title>COUNTER+ Estado</title>";
  html = html + "<head>";
  ...
  html = html + "<h1>COUNTER+ #Estado<span>ESP8266 tech</span></h1>";
...
void _serveTimeSETTINGS()
{
  ...
  html = "<!DOCTYPE HTML><html>";
  html = html + "<title>COUNTER+ #Configuraci&oacuten</title>";
  html = html + "<head>";
  html = html + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"/>";
  html = html + "<link rel=\"icon\" href=\"data:,\">";
  html = html + "<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\" />";
  ...
  html = html + "<body>";
  html = html + "<div class=\"myform\">";
  html = html + "<h1>COUNTER+ #Configuraci&oacuten<span>ESP8266 tech</span></h1>";
...
void _serveSETTINGS()
{
  ...
  html = html + "<body>";
  html = html + "<div class=\"myform\">";
  html = html + "<h1>COUNTER+ #Network settings<span>ESP8266 tech</span></h1>";
...
{ 
  ...
  if (inState == IN_STATUS_OFF)
   html = html + "<td><font style=\"color:green\">OFF</font></td>";
  else
...
{ 
  ...
  html = html + "<tr>";
  html = html + "<td>Uptime</td>";
  html = html + "<td>" + String(timeHour) + " : " + String(timeMin) + " : " + String(timeSec) + "</td>";
  html = html + "</tr>";

  html = html + "<tr>";
  html = html + "<td>Time Out Entrada (secs)</td>";
  html = html + "<td>" + String(countDownSec) + "</td>";
  html = html + "</tr>";
