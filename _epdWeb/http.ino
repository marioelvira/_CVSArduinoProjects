...
void _serveMAIN()
{
  ...
  html = html + "<title>EPD CONTROL+ Estado</title>";
  html = html + "<head>";
  ...
  html = html + "<h1>EPD CONTROL+ #Estado<span>ESP8266 tech</span><span align=\"right\"> Ver: " + FW_Version + "</span></h1>";

  html = html + "<div class=\"section\">Temporizaciones</div>";
  html = html + "<p class=\"sansserif\" id=\"TEMPSid\">...</p>";
  html = html + "<div class=\"section\">Pulsador</div>";
...
void _serveTimeSETTINGS()
{
  ...
  html = "<!DOCTYPE HTML><html>";
  html = html + "<title>EPD CONTROL+ #Configuraci&oacuten</title>";
  html = html + "<head>";
  html = html + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"/>";
  html = html + "<link rel=\"icon\" href=\"data:,\">";
  html = html + "<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\" />";
  ...
  html = html + "<body>";
  html = html + "<div class=\"myform\">";
  html = html + "<h1>EPD CONTROL+ #Configuraci&oacuten<span>ESP8266 tech</span><span align=\"right\"> Ver: " + FW_Version + "</span></h1>";
...
void _serveSETTINGS()
{
  ...
  html = "<!DOCTYPE HTML><html>";
  html = html + "<title>EPD CONTROL+ Network Settings</title>";
  html = html + "<head>";
  html = html + "<link rel=\"icon\" href=\"data:,\">";
  html = html + "<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\" />";
  ...
  html = html + "<body>";
  html = html + "<div class=\"myform\">";
  html = html + "<h1>EPD CONTROL+ #Network settings<span>ESP8266 tech</span><span align=\"right\"> Ver: " + FW_Version + "</span></h1>";
...
void _setSETTINGS()
{
  ...
  html = html + "<div class=\"myform\">";
  html = html + "<h1>GEN PANNEL+ #Network settings<span>ESP8266 tech</span><span align=\"right\"> Ver: " + FW_Version + "</span></h1>";
