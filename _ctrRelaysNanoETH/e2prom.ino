...
void _eeprom2ramCONFIG (void)
{
  ...
  Serial.print("C0 Irms Hys Sec"); Serial.print(": "); Serial.print (cfgC0ADCEmonSec); Serial.println(" sec");
  ...
  Serial.print("C1 Irms Hys Sec"); Serial.print(": "); Serial.print (cfgC1ADCEmonSec); Serial.println(" sec");
