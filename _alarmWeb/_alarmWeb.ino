...
{ 
  ...
  pinMode(PIN_RELE_BATT, OUTPUT);
  digitalWrite(PIN_RELE_BATT, PIN_OUT_OFF);
  outReleBatt = OUT_OFF;
...
void _PINLoop()
{
  ...
  */
  if (outLedInd == cfgLogicOuts /*OUT_OFF*/)
    digitalWrite(PIN_LED_IND, PIN_OUT_OFF);
  else
    digitalWrite(PIN_LED_IND, PIN_OUT_ON);

  if (outReleBatt == cfgLogicOuts /*OUT_OFF*/)
    digitalWrite(PIN_RELE_BATT, PIN_OUT_OFF);
  else
    digitalWrite(PIN_RELE_BATT, PIN_OUT_ON);
