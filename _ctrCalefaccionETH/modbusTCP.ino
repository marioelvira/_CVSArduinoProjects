...
void _ModbusTcpLoop()
{
  ...
  //Serial.print("Modbuds tcp server "); Serial.print(mbTcpServerStatus); Serial.println(" ***");
  //#endif
...
{
  //#if (_MBTCP_SERIAL_DEBUG_ == 1)
  //Serial.print("Modbuds tcp client "); Serial.print(mbTcpClientStatus); Serial.println(" ***");
  //#endif
  ...
  switch (mbTcpClientStatus)
  {
    case MB_CLIENT_INIT:
      ...
      if (mbTcpClient)
      {
        ...
        Serial.println(">>>>>>>>>>>>");
        Serial.print("Modbus tcp client connected: "); Serial.println(mbTcpClient);
        #endif
