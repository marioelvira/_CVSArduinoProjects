...
#define WIFI_SSID_MAX             16 // SSID max 16 char -> Next 0x1F
#define EEPROM_ADD_WIFI_PSWD      0x1F
#define WIFI_PSWD_MAX             16 // Password max 16 char -> Next 0x2F

#define EEPROM_ADD_MODBUS_ID      0x2F
