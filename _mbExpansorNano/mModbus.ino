...
void _mbReadInput(char address)
{
  ...
  // Meteo 
  if ((addr == MB_ADD_METEO)  && (nregs == MB_NREG_METEO))
  { 
    mrs485TxBuffer[0] = (char)address;
    mrs485TxBuffer[1] = (char)MB_FUNC_READ_INPUT_REGISTER;
    mrs485TxBuffer[2] = MB_NREG_METEO*2;
...
void _mbMeteoSN(char address)
{
  // Num Bytes
  mrs485TxNumBytes = 25;

  mrs485TxBuffer[0] = (char)address;
  mrs485TxBuffer[1] = (char)(MB_FUNC_METEO_CONF);
  mrs485TxBuffer[2] = (char)(MB_SFUNC_METEO_SN);

  mrs485TxBuffer[3] = 0x34;
  mrs485TxBuffer[4] = 0x38;
  mrs485TxBuffer[5] = 0x35;
  mrs485TxBuffer[6] = 0x33;
  mrs485TxBuffer[7] = 0x32;
  mrs485TxBuffer[8] = 0x30;
  mrs485TxBuffer[9] = 0x30;
  mrs485TxBuffer[10] = 0x33;
  mrs485TxBuffer[11] = 0x32;
  mrs485TxBuffer[12] = 0x31;
  mrs485TxBuffer[13] = 0x32;
  mrs485TxBuffer[14] = 0x31;
  mrs485TxBuffer[15] = 0x34;
  mrs485TxBuffer[16] = 0x38;
  mrs485TxBuffer[17] = 0x32;
  mrs485TxBuffer[18] = 0x37;
  mrs485TxBuffer[19] = 0x37;
  mrs485TxBuffer[20] = 0x30;
  mrs485TxBuffer[21] = 0x20;
  mrs485TxBuffer[22] = 0x20;
  
  // Crc
  _mbCRC();
  mrs485TxBuffer[23] = mbCRC[0];
  mrs485TxBuffer[24] = mbCRC[1];
...
int _mbN7(void)
{
    ...
    case MB_FUNC_METEO_CONF:
		_mbMeteoSN((char)cfgMbId);
      break;
