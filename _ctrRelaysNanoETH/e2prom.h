...
#define EEPROM_ADD_C0ADC_EMON_S_LO     0xA5
#define EEPROM_ADD_C0ADC_EMON_S_HI     0xA6
#define EEPROM_ADD_C0ADC_EMON_O_LO     0xA7
#define EEPROM_ADD_C0ADC_EMON_O_HI     0xA8
#define EEPROM_ADD_C0ADC_IDC_M_LO      0xA9
#define EEPROM_ADD_C0ADC_IDC_M_HI      0xAA
#define EEPROM_ADD_C0ADC_IDC_B_LO      0xAB
#define EEPROM_ADD_C0ADC_IDC_B_HI      0xAC
#define EEPROM_ADD_C0ADC_EMON_L_LO     0xAD
#define EEPROM_ADD_C0ADC_EMON_L_HI     0xAE
#define EEPROM_ADD_C0ADC_EMON_SEC_LO   0xAF
#define EEPROM_ADD_C0ADC_EMON_SEC_HI   0xB0

#define EEPROM_ADD_C1ADC_TYPE          0xB1
#define EEPROM_ADD_C1ADC_EMON_R_LO     0xB2
#define EEPROM_ADD_C1ADC_EMON_R_HI     0xB3
#define EEPROM_ADD_C1ADC_EMON_S_LO     0xB4
#define EEPROM_ADD_C1ADC_EMON_S_HI     0xB5
#define EEPROM_ADD_C1ADC_EMON_O_LO     0xB6
#define EEPROM_ADD_C1ADC_EMON_O_HI     0xB7
#define EEPROM_ADD_C1ADC_IDC_M_LO      0xB8
#define EEPROM_ADD_C1ADC_IDC_M_HI      0xB9
#define EEPROM_ADD_C1ADC_IDC_B_LO      0xBA
#define EEPROM_ADD_C1ADC_IDC_B_HI      0xBB
#define EEPROM_ADD_C1ADC_EMON_L_LO     0xBC
#define EEPROM_ADD_C1ADC_EMON_L_HI     0xBD
#define EEPROM_ADD_C1ADC_EMON_SEC_LO   0xBE
#define EEPROM_ADD_C1ADC_EMON_SEC_HI   0xBF
#define EEPROM_ADD_V0ADC_VDC_M_LO      0xC0
#define EEPROM_ADD_V0ADC_VDC_M_HI      0xC1
#define EEPROM_ADD_V0ADC_VDC_B_LO      0xC2
#define EEPROM_ADD_V0ADC_VDC_B_HI      0xC3
