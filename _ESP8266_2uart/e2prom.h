...
#define EEPROM_ADD_LOGIC_RXTX0    0x50
#define EEPROM_ADD_LOGIC_RXTX2    0x51

#define EEPROM_ADD_UART0_TOUT_LO  0x52
#define EEPROM_ADD_UART0_TOUT_HI  0x53
...
#define EEPROM_VAL_LOGIC_RXTX0    0
#define EEPROM_VAL_LOGIC_RXTX2    1

#define EEPROM_VAL_UART0_TOUT     100  // 100ms
